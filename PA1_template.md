...
**This document contains the completed work for peer assignment #1 for the Coursera Reproducible Research course.**

###Loading & Preprocessing Data

---

First, I will download the dataset required for this assignment.  Description of this data from course website: 
